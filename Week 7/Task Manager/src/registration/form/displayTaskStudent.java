 ...
 * @author Kaye
 */
public class displayTaskStudent extends javax.swing.JFrame {

    DBHelper dbh = new DBHelper();
    /**
     * Creates new form displayTaskStudent
     */
    public displayTaskStudent() {
        initComponents();
        try {
            dbh.connectDB();
        } catch (Exception ex) {
            Logger.getLogger(displayTaskStudent.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(displayTaskStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
